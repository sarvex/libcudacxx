...
#pragma nv_diag_suppress 2734 // invalid arithmetic on non-array pointer
#pragma nv_diag_suppress 2693 // invalid arithmetic on non-array pointer
...
__device__ TEST_CONSTEXPR  C gC[1];
...
#if TEST_STD_VER > 14 && !defined(__CUDACC_RTC__)
  {
