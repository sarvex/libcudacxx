...
struct __db_destruct_base {
  ...
  constexpr __db_destruct_base() noexcept {};

  template<class ..._Args>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __db_destruct_base(in_place_t, _Args&& ...__args)
    noexcept(is_nothrow_constructible_v<_Tp, _Args...>)
    : __val_(_CUDA_VSTD::forward<_Args>(__args)...), __engaged_(true)
  { }

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 ~__db_destruct_base() noexcept {
    if (__engaged_) {
      __val_.~_Tp();
    }
  }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void __reset() noexcept
  {
    if (__engaged_) {
      __val_.~_Tp();
      __engaged_ = false;
...
struct __db_copy_base : public __db_destruct_base<_Tp> {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base() = default;
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base(const __db_copy_base&) = delete;
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base& operator=(const __db_copy_base&) = delete;

  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base(__db_copy_base&&) = default;
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base& operator=(__db_copy_base&&) = default;
};
...
struct __db_copy_base<_Tp, enable_if_t<copyable<_Tp>>> : public __db_destruct_base<_Tp> {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base(const __db_copy_base&) requires is_trivially_copy_constructible_v<_Tp> = default;
#endif

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __db_copy_base(const __db_copy_base& __other)
...
#if _LIBCUDACXX_STD_VER > 17
  _LIBCUDACXX_HIDE_FROM_ABI __db_copy_base& operator=(const __db_copy_base&)
    requires copyable<_Tp> && is_trivially_copy_assignable_v<_Tp> = default;
#endif

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __db_copy_base& operator=(const __db_copy_base& __other)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __db_copy_base& operator=(const _Tp& __val)
    noexcept(is_nothrow_copy_constructible_v<_Tp> && is_nothrow_copy_assignable_v<_Tp>) {
    if (this->__engaged_) {
      this->__val_ = __val;
    } else {
      _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__val_), __val);
      this->__engaged_ = true;
    }
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __defaultable_box(const __defaultable_box&) = default;
  _LIBCUDACXX_HIDE_FROM_ABI __defaultable_box& operator=(const __defaultable_box&) = default;
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __defaultable_box(__defaultable_box&& __other)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __defaultable_box(const __defaultable_box<_Up>& __other)
    noexcept(is_nothrow_copy_constructible_v<_Tp>) : __base() {
    if (__other) {
      _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__val_), __other.__val_);
      this->__engaged_ = true;
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __defaultable_box(__defaultable_box<_Up>&& __other)
    noexcept(is_nothrow_copy_constructible_v<_Tp>) : __base() {
    if (__other) {
      _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__val_), _CUDA_VSTD::move(__other.__val_));
      this->__engaged_ = true;
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __defaultable_box& operator=(__defaultable_box&& __other)
  ...
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __defaultable_box& operator=(_Tp&& __val)
    ...
    if (this->__engaged_) {
      ...
      _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__val_), _CUDA_VSTD::move(__val));
      this->__engaged_ = true;
    }
