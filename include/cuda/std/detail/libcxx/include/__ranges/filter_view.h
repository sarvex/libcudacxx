...
// It seems nvcc has a bug where the noexcept specification is incorrectly set
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    friend constexpr auto operator==(__iterator const& __x, __iterator const& __y)
    ...
    template<class _View2 = _View>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    friend constexpr auto iter_swap(__iterator const& __x, __iterator const& __y)
...
#if _LIBCUDACXX_STD_VER < 20
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    friend constexpr bool operator==(__sentinel const& __x, __iterator const& __y) {
