...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit elements_view(_View __base) noexcept(is_nothrow_move_constructible_v<_View>)
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __elements_view_iterator(iterator_t<_Base> __current) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __elements_view_iterator(__elements_view_iterator<_View, _Np, !_Const2> __i)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr iterator_t<_Base> base() && { return _CUDA_VSTD::move(__current_); }
  ...
  _LIBCUDACXX_TEMPLATE(bool _Const2 = _Const)
    (requires forward_range<_Base2<_Const2>>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __elements_view_iterator operator++(int) {
    auto temp = *this;
    ++__current_;
    return temp;
  }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __elements_view_iterator& operator+=(difference_type __n) {
    __current_ += __n;
    return *this;
  }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator==(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
  ...
  template<bool _Const2 = _Const>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator+(const __elements_view_iterator& __x, difference_type __y)
  ...
  template<bool _Const2 = _Const>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator+(difference_type __x, const __elements_view_iterator& __y)
  _LIBCUDACXX_TRAILING_REQUIRES(__elements_view_iterator)(requires random_access_range<_Base2<_Const2>>) {
    return __y + __x;
  }
...
public:
  _LIBCUDACXX_HIDE_FROM_ABI __elements_view_sentinel() = default;

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __elements_view_sentinel(sentinel_t<_Base> __end)
    : __end_(_CUDA_VSTD::move(__end)) {}

  _LIBCUDACXX_TEMPLATE(bool _Const2 = _Const)
    (requires _Const2 _LIBCUDACXX_AND convertible_to<sentinel_t<_View>, sentinel_t<_Base>>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __elements_view_sentinel(__elements_view_sentinel<_View, _Np, !_Const2> __other)
  ...
  template<bool _OtherConst>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator==(const __elements_view_iterator<_View, _Np, _OtherConst>& __x, const __elements_view_sentinel& __y)
  ...
  template<bool _OtherConst>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator==(const __elements_view_sentinel& __y, const __elements_view_iterator<_View, _Np, _OtherConst>& __x)
  _LIBCUDACXX_TRAILING_REQUIRES(bool)(requires sentinel_for<sentinel_t<_Base>, iterator_t<__maybe_const<_OtherConst, _View>>>) {
    return __get_current(__x) == __y.__end_;
  }
  template<bool _OtherConst>
  ...
  template <bool _OtherConst>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  friend constexpr auto operator-(const __elements_view_sentinel& __x, const __elements_view_iterator<_View, _Np, _OtherConst>& __y)
  _LIBCUDACXX_TRAILING_REQUIRES(range_difference_t<__maybe_const<_OtherConst, _View>>)
  (requires sized_sentinel_for<sentinel_t<_Base>, iterator_t<__maybe_const<_OtherConst, _View>>>) {
