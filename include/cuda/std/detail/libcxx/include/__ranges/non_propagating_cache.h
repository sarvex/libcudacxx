...
_LIBCUDACXX_BEGIN_NAMESPACE_RANGES_ABI
  ...
  struct __wrapper {
    ...
    constexpr explicit __wrapper(__forward_tag, _Args&& ...__args) : __t_(_CUDA_VSTD::forward<_Args>(__args)...) { }
    _Tp __t_;
  };
  ...
  struct __npc_destruct_base {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __npc_destruct_base() noexcept {}

    template<class ..._Args>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __npc_destruct_base(__forward_tag, _Args&& ...__args)
      noexcept(is_nothrow_constructible_v<_Tp, _Args...>)
      : __val_(__forward_tag{}, _CUDA_VSTD::forward<_Args>(__args)...), __engaged_(true)
    { }

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 ~__npc_destruct_base() noexcept {
        if (__engaged_) {
            __val_.~_Tp();
        }
    }
  ...
  public:
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __non_propagating_cache() noexcept : __base() {}

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __non_propagating_cache(const __non_propagating_cache&) noexcept : __base() { }

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __non_propagating_cache(__non_propagating_cache&& __other) noexcept : __base()
    {
      __other.__reset();
    }

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr __non_propagating_cache& operator=(const __non_propagating_cache& __other) noexcept {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr _Tp& operator*() { return this->__val_.__t_; }
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr _Tp const& operator*() const { return this->__val_.__t_; }

    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    constexpr bool __has_value() const noexcept { return this->__engaged_; }

    template<class ..._Args>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
    _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 _Tp& __emplace(_Args&& ...__args) noexcept(is_nothrow_constructible_v<_Tp, _Args...>) {
      _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__val_), __forward_tag{}, _CUDA_VSTD::forward<_Args>(__args)...);
