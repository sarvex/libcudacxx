...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr drop_while_view(_View __base, _Pred __pred)
      : view_interface<drop_while_view<_View, _Pred>>()
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto end() { return _CUDA_VRANGES::end(__base_); }
};
