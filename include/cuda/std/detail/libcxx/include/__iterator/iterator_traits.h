...
private:
    template <class _Up>
    _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER _LIBCUDACXX_INLINE_VISIBILITY static false_type __test(...);
    template <class _Up>
    _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER _LIBCUDACXX_INLINE_VISIBILITY
...
{
private:
    template <class _Up> _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER static false_type __test(...);
    template <class _Up> _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER static true_type __test(typename _Up::iterator_category* = nullptr);
public:
...
private:
    template <class _Up> _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER static false_type __test(...);
    template <class _Up> _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER static true_type __test(typename _Up::iterator_concept* = nullptr);
public:
    static const bool value = decltype(__test<_Tp>(nullptr))::value;
};
