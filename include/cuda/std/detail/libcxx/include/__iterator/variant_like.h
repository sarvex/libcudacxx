...
struct __vl_destruct_base {
  ...
  constexpr explicit __vl_destruct_base(__variant_like_state __state) noexcept : __contains_{__state} {}

  _LIBCUDACXX_TEMPLATE(class _Tp2 = _Tp)
    (requires default_initializable<_Tp2>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr __vl_destruct_base() noexcept(is_nothrow_default_constructible_v<_Tp2>)
    : __first_{}, __contains_{__variant_like_state::__holds_first} {}

  template <class... _Types>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __vl_destruct_base(in_place_type_t<_Tp>, _Types&&... _Args) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr explicit __vl_destruct_base(in_place_type_t<_Up>, _Types&&... _Args) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 ~__vl_destruct_base() {
    __raw_clear();
  }

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void __raw_clear() noexcept {
    switch (__contains_) {
...
struct __vl_destruct_base<_Tp, _Up, enable_if_t<is_trivially_destructible_v<_Tp> &&
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr void __raw_clear() noexcept {}
};
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like(const __variant_like& __other) noexcept(
    is_nothrow_copy_constructible_v<_Tp>&& is_nothrow_copy_constructible_v<_Up>)
    : __base{__other.__contains_} {
    switch (this->__contains_) {
    case __variant_like_state::__holds_first:
        _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__first_), __other.__first_);
        break;
    case __variant_like_state::__holds_second:
        _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__second_), __other.__second_);
        break;
    case __variant_like_state::__nothing:
        break;
    }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like(const __variant_like<_OTp, _OUp>& __other) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like(__variant_like&& __other) noexcept(
    is_nothrow_move_constructible_v<_Tp>&& is_nothrow_move_constructible_v<_Up>)
    : __base{__other.__contains_} {
    switch (this->__contains_) {
    case __variant_like_state::__holds_first:
        _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__first_), _CUDA_VSTD::move(__other.__first_));
        break;
    case __variant_like_state::__holds_second:
        _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__second_), _CUDA_VSTD::move(__other.__second_));
        break;
    case __variant_like_state::__nothing:
        break;
    }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like& operator=(const __variant_like& __other) noexcept(
    is_nothrow_copy_constructible_v<_Tp>&& is_nothrow_copy_constructible_v<_Up>&&
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like& operator=(__variant_like&& __other) noexcept(
    is_nothrow_move_constructible_v<_Tp>&& is_nothrow_move_constructible_v<_Up>&&
  ...
  _LIBCUDACXX_TEMPLATE(class _OTp, class _OUp)
    (requires (!same_as<__variant_like<_OTp, _OUp>, __variant_like>))
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __variant_like& operator=(const __variant_like<_OTp, _OUp>& __other) noexcept(
    is_nothrow_constructible_v<_Tp, const _OTp&> && is_nothrow_constructible_v<_Up, const _OUp&>
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr void __clear() noexcept {
    this->__raw_clear();
  ...
  template <class... _Types>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void __emplace_first(_Types&&... _Args) noexcept(is_nothrow_constructible_v<_Tp, _Types...>) {
    this->__raw_clear();
    this->__contains_ = __variant_like_state::__nothing;

    _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__first_), _CUDA_VSTD::forward<_Types>(_Args)...);
    this->__contains_ = __variant_like_state::__holds_first;
  }

  template <class... _Types>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 void __emplace_second(_Types&&... _Args) noexcept(is_nothrow_constructible_v<_Up, _Types...>) {
    this->__raw_clear();
    this->__contains_ = __variant_like_state::__nothing;

    _CUDA_VSTD::construct_at(_CUDA_VSTD::addressof(this->__second_), _CUDA_VSTD::forward<_Types>(_Args)...);
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr bool __holds_first() const noexcept {
    return this->__contains_ == __variant_like_state::__holds_first;
  }
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
  constexpr bool __holds_second() const noexcept {
