...
template<class _Tp>
struct __cond_value_type<_Tp, enable_if_t<is_object_v<_Tp>>> { using value_type = remove_cv_t<_Tp>; };
...
template<class _Tp>
struct indirectly_readable_traits<_Tp, enable_if_t<!is_const_v<_Tp> && __has_member_value_type<_Tp> && !__has_member_element_type<_Tp>>>
  : __cond_value_type<typename _Tp::value_type> {};
